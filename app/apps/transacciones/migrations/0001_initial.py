# Generated by Django 5.2.5 on 2025-09-04 01:59
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "identificador",
                    models.CharField(help_text="Email, número de teléfono o ID de la billetera", max_length=100),
                ),
                ...
                (
                    "cliente",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="%(class)s_set", to="usuarios.cliente"
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("ruc_titular", models.CharField(blank=True, max_length=12)),
                (
                    "cliente",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="%(class)s_set", to="usuarios.cliente"
