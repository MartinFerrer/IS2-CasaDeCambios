        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "comision",
                    models.DecimalField(
                        decimal_places=2, default=Decimal("0.00"), max_digits=5, verbose_name="Comisión (%)"
                    ),
                ),
                (
                    "tasa_actual",
                    models.DecimalField(
                        decimal_places=4, default=Decimal("0.0000"), max_digits=10, verbose_name="Tasa Actual"
                    ),
                ),
            ],
        ),
