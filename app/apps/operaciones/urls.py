...
urlpatterns = [
    ...
    path("admin/tasas-de-cambio/", views.tasa_cambio_listar, name="tasa_cambio_listar"),
    path("admin/tasas-de-cambio/crear/", views.tasa_cambio_crear, name="tasa_cambio_crear"),
    path("admin/tasas-de-cambio/<uuid:pk>/editar/", views.tasa_cambio_editar, name="tasa_cambio_editar"),
    path("admin/tasas-de-cambio/<uuid:pk>/desactivar/", views.tasa_cambio_desactivar, name="tasa_cambio_desactivar"),
    path("admin/tasas-de-cambio/<uuid:pk>/activar/", views.tasa_cambio_activar, name="tasa_cambio_activar"),
